...
$user = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM ure_form WHERE user_id = $sessionId"));
?>
<!DOCTYPE html>
  ...
  <body>
    ...
    if(isset($_FILES["image"]["name"])){
      ...
      elseif ($imageSize > 1200000){
        ...
        $query = "UPDATE profile_user SET image = '$newImageName' WHERE user_id = $id";
